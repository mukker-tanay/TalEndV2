    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
      ...
      >
        <div className="text-center mb-8">
          <h2 className="text-3xl font-extrabold text-slate-100 tracking-tight">Security Update</h2>
          <p className="mt-2 text-sm text-slate-400">Please update your temporary password to continue</p>
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white font-semibold py-2.5 rounded-xl mt-6 shadow-lg shadow-indigo-600/20 hover:shadow-indigo-500/30 transition-all duration-200"
        >
        ...
        <button
          ...
          className="w-full text-slate-400 hover:text-slate-300 text-sm font-semibold py-2.5 mt-2 transition-all duration-200"
        >
          Cancel and Sign Out
        </button>
      </form>
